...
$recipient_email    = 'universal.amanaggarwal@gmail.com'; //recepient
...
if($_POST){
    ...
    if(empty($_POST["contact"])){ //check for valid numbers in contact number field
        print 'Enter only digits in contact number';
        exit;
    }
